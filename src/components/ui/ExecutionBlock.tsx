...
export function ExecutionBlock({ title, description, outcomes, index = 0 }: ExecutionBlockProps) {
  ...
  return (
    <div
      ...
      className={`
        group rounded-lg border border-gray-200 bg-white p-8 shadow-sm transition-all duration-700
        hover:border-[var(--color-secondary-blue)] hover:shadow-lg
    ...
    >
      ...
      <div className="space-y-3">
        <h4 className="text-sm font-semibold uppercase tracking-wide text-[var(--color-secondary-blue)]">
          Key Outcomes
        </h4>
            ...
            >
              ...
              <svg
                className={`mt-0.5 h-5 w-5 flex-shrink-0 transition-all duration-300 ${
                  isHovered ? "text-[var(--color-accent-blue)]" : "text-[var(--color-secondary-blue)]"
                }`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
